...
/**
 * The traversal has two important filters: - performance/pruning filter - that can cut out entire folders from final
 * result (you don't need to test that cuts only folders since this will affect performance. - final filter - to define
